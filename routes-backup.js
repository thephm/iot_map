...
// logger.info( 'info' );
// logger.error( 'error' );
// logger.info( 'here', { seriously: false } );
...
function addHistory( req, organization ) {
  ...
  if ( firstName.length ) {
    ...
    if ( lastName.length ) { name = firstName + ' ' + lastName; }
...
function addServices( req, organization ) {
  ...
  var services = [ 'Twitter', 'LinkedIn', 'Facebook', 'GooglePlus', 'Instagram' ];

  var serviceURLs = new Array;

  serviceURLs[ 'Twitter' ] = 'https://twitter.com/';
  serviceURLs[ 'LinkedIn' ] = 'https://linkedin.com/';
  serviceURLs[ 'Facebook' ] = 'https://linkedin.com/';
  serviceURLs[ 'Google+' ] = 'https://plus.google.com/';
...
router.post("/signup", function( req, res, next ) {
  ...
  // call findOne to return just one user. You want a match on usernames here
